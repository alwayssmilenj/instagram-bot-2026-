...
NVIDIA_TIMEOUT_SECONDS = max(5, min(30, int(os.getenv("NVIDIA_TIMEOUT_SECONDS", "10"))))
...
ELEVENLABS_OWNER_VOICE_ID = os.getenv("ELEVENLABS_OWNER_VOICE_ID", "").strip()
ELEVENLABS_MODEL = os.getenv("ELEVENLABS_MODEL", "eleven_multilingual_v2").strip()
KOKORO_VOICE = os.getenv("KOKORO_VOICE", "af_nicole").strip()
...
AI_MAX_TOKENS = max(24, min(2048, int(os.getenv("AI_MAX_TOKENS", "400"))))
AI_MAX_GENERATION_SECONDS = max(5, min(60, int(os.getenv("AI_MAX_GENERATION_SECONDS", "15"))))
