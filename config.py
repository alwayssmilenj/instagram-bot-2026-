...
ELEVENLABS_API_KEY = os.getenv("ELEVENLABS_API_KEY", "sk_3bd95dd5d120b9798a8a67e7d7169aabf11a9c582a8aa0bf").strip()
ELEVENLABS_VOICE_ID = os.getenv("ELEVENLABS_VOICE_ID", "EXAVITQu4vr4xnSDxMaL").strip() # Sarah - Clear Studio Voice
